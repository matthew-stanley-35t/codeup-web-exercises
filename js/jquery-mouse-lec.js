...
document.getElementById('importanter-circle').addEventListener('click', function() {
    this.style = 'background-image: url(../imgs/europa.webp); background-size: cover;';
});

// With jQuery, we can do it even easier!

$('#important-circle').click(function() {
    $(this).css('background-image','url(../imgs/io.png)').css('background-size','cover');
});
...
$('.grandma').hover(function() {
    $(this).css('background-image','url(../imgs/jupiter-coin.webp)');
}, function() {
    $(this).css('background-image','url(../imgs/jupiter.webp)');
});
...
//     console.log(val);
//     if (val === 'pikachu') {
//         $('#picture-example').html('<img class="push" src="imgs/pikachu.gif" alt="pikachu gif">');
//     } else if (val === 'dragonite') {
//         $('#picture-example').html('<img class="push" src="imgs/dragonite.gif" alt="dragonite gif">');
//     } else {
//         $('#picture-example').html('<img class="push" src="imgs/you-were-close.png" alt="you were close">');
//     }
// });
